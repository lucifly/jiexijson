...
******************************************************** */
var my_edges = obj.edges;//有向边数组
 
 
var node_num = my_node.length;//节点数量
...
******************************************************* */
var node_arry = new Array();//节点信息数组
...
edge_arry[][]     0 0 1 0
   ...
   1->0->2->3     0 0 0 0
******************************************************** */
var edge_arry = new Array();//节点邻接矩阵
...
******************************************************** */
var node_io_arry = new Array();//存节点输出情况
